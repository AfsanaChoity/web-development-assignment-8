...
const  WishListBook = (item) => {
    ...
    const { image, bookName, author, category, tags, totalPages, publisher, yearOfPublishing, rating, bookId } = item;
    return (
        <div>
                ...
                <div className="hero-content flex-col lg:flex-row ">
                    ...
                    <div>
                        ...
                        <div className="flex text-xs gap-4 items-center">
                            ...
                            <p className="flex"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 25" fill="none">
                            ...
                            </svg>Year of Publishing: {yearOfPublishing}</p>
                        </div>

                        <div className="flex text-xs text-[#131313] opacity-60 my-5 gap-6">
                            <p className="flex gap-1 items-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
